...
public class CuaHangFoodAdapterLuu extends BaseAdapter {

    private Context context;
    private List<CuaHangFood> cuaHangFoodList;

    public CuaHangFoodAdapterLuu(Context context, List<CuaHangFood> cuaHangFoodList){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            view = LayoutInflater.from(context).inflate(R.layout.list_luu, null);
            holder = new ViewHolder(view);
            holder.mImage = view.findViewById(R.id.hh);
            holder.mTen = view.findViewById(R.id.tt1);
            holder.mMota = view.findViewById(R.id.tt2);
